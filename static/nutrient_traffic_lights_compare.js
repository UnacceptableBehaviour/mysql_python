...
document.querySelector('#b_update_0').addEventListener('mousedown', display_template_params(0));
...
document.querySelector('#compare_table_btns').appendChild(clear_button);
