...
function loadServingModifierLUT(){
  ...
  var lut = {
    ...
    'apple': { 'small': 120.0, 'medium': 160.0, 'large': 200.0, 'density': 1.0 },
    ...
    'brazil nut': { 'small': 2.2, 'medium': 3.0, 'large': 3.8, 'density': 1.0 },
    ...
    'garlic cloves': { 'small': 3.0, 'medium': 4.0, 'large': 5.0, 'density': 1.0 },
    'giant mrs yorkshire pudding': { 'small': 82.5, 'medium': 110.0, 'large': 137.5, 'density': 1.0 },
    'grape': { 'small': 4.9, 'medium': 6.5, 'large': 8.1, 'density': 1.0 },
    'green olif': { 'small': 2.1, 'medium': 2.8, 'large': 3.5, 'density': 1.0 },
    ...
    'place (inc bone) - bone: 70g': { 'small': 217.5, 'medium': 290.0, 'large': 362.5, 'density': 1.0 },
    ...
    'pringle': { 'small': 1.7, 'medium': 2.3, 'large': 2.9, 'density': 1.0 },
    'prune': { 'small': 5.6, 'medium': 7.5, 'large': 9.4, 'density': 1.0 },
    'radish': { 'small': 8.8, 'medium': 11.7, 'large': 14.6, 'density': 1.0 },
    'raspberry and white choc chip cookies': { 'small': 54.0, 'medium': 72.0, 'large': 90.0, 'density': 1.0 },
    ...
    'smoked mackerel fillet': { 'small': 48.5, 'medium': 64.7, 'large': 80.9, 'density': 1.0 },
    ...
    'white mushroom': { 'small': 17.6, 'medium': 23.5, 'large': 29.4, 'density': 1.0 },
    'wrap': { 'small': 30.0, 'medium': 40.0, 'large': 50.0, 'density': 1.0 },
    'dcx' : { 'small':  0.1, 'medium': 0.1, 'large':  0.1, 'density': 1.0 },
